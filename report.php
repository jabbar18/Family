...
<div >
  <div class="main-inner">
    <div class="container">
      ...
      <?php
        $reports = selectSubjectReport($_GET['subjectid'], $_SESSION['id']);

        for($i = 0; $i < count($reports); $i++){

          $lastYear = $reports[$i]['year'];
        ...
        <div class="span7" style="margin-left:20%;">
          ...
          <div class="widget widget-table action-table">
            <div class="widget-header"> <i class="icon-user"></i>
              <h3><?php echo $reports[$i]['year'] .' - ' .$_GET['title']; ?> Attandence</h3>
            </div>
              ...
              <table class="table table-striped table-bordered">
                <thead>
                  <tr>
                    ...
                    <th class="td-actions"> Student Name </th>
                ...
                <tbody>
                  <?php
                      ...
                      for($j = $i; $j < count($reports); $j++, $i++){
                        ...
                        if($lastYear == $report['year']){

                  ?>
                        <tr>
                          
                          <td> <?php echo $report['name'] ?> </td>
                          <td> <?php echo $report['roll_number'] ?> </td>
