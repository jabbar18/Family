                      ...
                      include_once('ToDoDB.php');
                        ...
                        <form action="EventsHandler.php" method="post" class="form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" readonly class="span4" id="title" name="title" value=" <?php  echo $aEvents[0]['Title'] ?>" required>
                                </div> <!-- /controls -->
                            </div> <!-- /control-group -->
                          ...
                          <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <select readonly required class="mdb-select md-form colorful-select dropdown-primary" multiple searchable="Search here.." name="Members[]">
                              ]
                                    <?php 
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" readonly class="span4" id="tododate" name="tododate"  value=" <?php  echo $aEvents[0]['Date'] ?>"   required>
                                </div> <!-- /controls -->
                            </div> <!-- /control-group -->
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" readonly class="span4" id="description" name="description"  value=" <?php  echo $aEvents[0]['Description'] ?>"   required>
                                </div> <!-- /controls -->
                            </div> <!-- /control-group -->
