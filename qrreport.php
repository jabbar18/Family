  ...
  <div class="main-inner">
    <div class="container">
        ...
        <div class="span5" style="margin-left:30%;">
            ...
            <div class="widget" style="margin-top:15%;" >
              
              <div class="widget-header">
                <i class="icon-user"></i>
                <h3>Scan Your QR-CODE To View Your Attendance Report</h3>
            </div> <!-- /widget-header -->
          ...
          <div class="widget-content">
                  ...
                  <a  style="margin-left:40%;" href='index.php'>Login</a>
          </div>
        </div>
...
$(document).ready(function(){
  $('#reader').html5_qrcode(function(qrdata){
      $.post( "./files/studenthandler.php", { m: "qr", data: qrdata})
      .done(function( data ) {
          if(data == 'n'){
            $('#status').html('Sorry, Your QR Can\'t Be Used As Student.');
          }else{
            window.location = "./studentreport.php?studentid=" +qrdata; 
          }
      });
