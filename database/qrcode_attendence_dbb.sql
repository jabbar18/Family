...
ALTER TABLE `attendence`
  ...
  ADD KEY `fk_attendence_teacher_idx` (`teacher_id`),
...
ALTER TABLE `teacher_has_subjects`
  ...
  ADD KEY `fk_subject_has_teacher_teacher1_idx` (`teacher_id`),
  ADD KEY `fk_subject_has_teacher_subject1_idx` (`subject_id`);
...
ALTER TABLE `attendence`
  ...
  ADD CONSTRAINT `fk_attendence_teacher` FOREIGN KEY (`teacher_id`) REFERENCES `teacher` (`teacher_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `teacher_has_subjects`
  ADD CONSTRAINT `fk_subject_has_teacher_subject1` FOREIGN KEY (`subject_id`) REFERENCES `subject` (`subject_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_subject_has_teacher_teacher1` FOREIGN KEY (`teacher_id`) REFERENCES `teacher` (`teacher_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
