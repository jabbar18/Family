                            ...
                            <form action="EventsHandler.php" method="post" role="form">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea  class="form-control" id="des" name="des" placeholder="Event Description"></textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="eo">Event Organizor</label>

                                        <select name="eo" id="eo" class="form-control" aria-multiselectable="true" >
                                            <?php
                                    ...
                                    <div class="form-group">
                                        <label for="email">Event Date/Time</label>
                                        <input type="datetime-local" class="form-control" id="ed" name="ed">
                                    </div>
