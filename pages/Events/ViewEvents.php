                            ...
                            <form action="EventsHandler.php" method="post" role="form">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name"  required value="<?php echo $aRecords[0]['EventName'] ?>" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="name">Event Description</label>
                                       <p>
                                           <?php echo $aRecords[0]['Description'] ?>
                                       </p>
                                    </div>

                                    <div class="form-group">
                                        <label for="smothername">Event Organizor</label>

                                        <select name="smothername" id="smothername" class="form-control" disabled>
                                            <?php

                                            $iOrganizorId = $aRecords[0]['EventOrganizorId'];
                                    ...
                                    <div class="form-group">
                                        <label for="ed">Event Location</label>
                                        <input type="text" class="form-control" id="ed" name="ed" value="<?php echo $aRecords[0]['Location'] ?>" disabled>
                                    </div>
