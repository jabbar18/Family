                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="sfathername" id="sfathername" class="form-control">
                                            <option value="0" disabled selected>Select Father Name</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="smothername" id="smothername" class="form-control">
                                            <option value="0" disabled selected>Select Mother Name</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="cnumber" name="cnumber" placeholder="Contact Number">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="money" name="money" placeholder="Monthly Pocket Money">
                                    </div>

                                    <div class="form-group">
                                        <label for="accountbalance">Account Balance</label>
                                        <input type="number" class="form-control" id="accountbalance" name="accountbalance" placeholder="Account Balance">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="saddress" name="saddress" placeholder="School Address">
                                    </div>


                                    <div class="form-group">
                                        <label for="scontact">School Contact Number</label>
                                        <input type="number" class="form-control" id="scontact" name="scontact" placeholder="School Contact Number">
                                    </div>


                                    <div class="form-group">
                                        <label for="sfees">School Fees</label>
                                        <input type="number" class="form-control" id="sfees" name="sfees" placeholder="School Fees">
                                    </div>

                                    <div class="form-group">
                                        <label for="slatitude">School Latitude</label>
                                        <input type="number" class="form-control" id="slatitude" name="slatitude" placeholder="School Latitude">
                                    </div>

                                    <div class="form-group">
                                        <label for="slongitude">School Longitude</label>
                                        <input type="number" class="form-control" id="slongitude" name="slongitude" placeholder="School Longitude">
                                    </div>
