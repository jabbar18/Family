                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li>
                                        <a href="#">
                                            <i class="fa fa-users text-aqua"></i> 5 new Expenses joined today
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                    ...
                                    <li>
                                        <a href="#">
                                            <i class="fa fa-users text-red"></i> 5 new Expenses joined
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                        ...
                        <div class="box-header">
                            ...
                            <div class="box-tools">
                                <div class="input-group input-group-sm" style="width: 150px;">
                                    <h3 class="box-title"><a href="AddExpenses.php"><button type="button" class="btn btn-block btn-success"><i class="fa fa-plus"></i> Add Expenses</button></a></h3>
