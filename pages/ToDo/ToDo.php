                        ...
                        <div class="box-header">
                            ...
                            <div class="box-tools">
                                <div class="input-group input-group-sm" style="width: 150px;">
                                    <h3 class="box-title"><a href="AddToDo.php"><button type="button" class="btn btn-block btn-success"><i class="fa fa-plus"></i> Add ToDo</button></a></h3>
                            ...
                            <table class="table table-hover">
                                ...
                                foreach($aToDos as $aToDo)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td> <?php echo $aToDo['TodoDate'] ?> </td>
                                        <td> <?php echo $aToDo['DeadlineDate'] ?> </td>
                                        <td ><a href="./ViewToDo.php?To_Do_Id=<?php echo $aToDo['TodoId'] ?>" <button type="button" class="btn btn-info"><i class="fa fa-eye"></i></button></a></td>
<!--                                        <td ><a href="./EditToDo.php?To_Do_Id=--><?php //echo $aToDo['TodoId'] ?><!--" class="btn w3-blue btn-small"><i class="btn-icon-only icon-eye-open"> </i></a></td>-->
                                        <td ><a href="ToDoHandler.php?action=DeleteRecord&To_Do_Id=<?php echo $aToDo['TodoId'] ?>" <button type="button" class="btn btn-danger"><i class="fa fa-remove"></i></button></a></td>
                                    </tr>
                                    <?php
                                }
                                ?>
