...
else
{
    ...
    $iRecordId = $_GET['PlaceId'];

    $aEventsMembers = SelectAllPlaceMember($iRecordId);

    $aRecords = SelectAllPlaces($iRecordId);
                            ...
                            <form action="EventsHandler.php" method="post" role="form">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name"  required value="<?php echo $aRecords[0]['PlaceName'] ?>" disabled>
                                    </div>


                                    <div class="form-group">
                                        <label for="smothername">Place Member</label>

                                        <select name="smothername" id="smothername" class="form-control" disabled>
                                            <?php

                                            $iOrganizorId = $aRecords[0]['MemberId'];
                                    ...
                                    <div class="form-group">
                                        <label for="sfathername">Notifications Members</label>
                                    ...
                                    <div class="form-group">
                                        <label for="ed">Latitude</label>
                                        <input type="datetime" class="form-control" id="ed" name="ed" value="<?php echo $aRecords[0]['Latitude'] ?>" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="ed">Longitude</label>
                                        <input type="text" class="form-control" id="ed" name="ed" value="<?php echo $aRecords[0]['Longitude'] ?>" disabled>
                                    </div>
