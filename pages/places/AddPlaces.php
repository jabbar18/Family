                ...
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-body table-responsive no-padding">
                            <form action="PlacesHandler.php" method="post" role="form">

                                <input type="hidden" name="action" value="AddRecord" />
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="name">Place Name</label>
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Place Name" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="po">Place Member</label>

                                        <select name="po" id="po" class="form-control" aria-multiselectable="true" >
                                            <?php
                                    ...
                                    <div class="form-group">
                                        <label for="Members[]">Notifications Members</label>
                                    ...
                                    <div class="form-group">
                                        <label for="email">Place Latitude</label>
                                        <input type="number" class="form-control" id="lt" name="lt" placeholder="Latitude">

                                    </div>

                                    <div class="form-group">
                                        <label for="email">Place Longitude</label>
                                        <input type="number" class="form-control" id="ln" name="ln" placeholder="Longitude">
                                    </div>
