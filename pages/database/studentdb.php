...
//Create Student
function addAttendenceOfStudent($member_id, $student_id, $subject_id, $date, $attendence_year, $semester){
	establishConnectionToDatabase();

	$query = "insert into attendence (member_id, subject_id, student_id, date, attendence_year, semester) value($member_id, $subject_id, $student_id, '$date', '$attendence_year', $semester)";
	$result = mysqli_query($GLOBALS['link'], $query);
...
function canStudentDoAttendence($member_id, $subject_id, $student_id, $date){
	establishConnectionToDatabase();

	$query = "select *  from attendence where member_id = $member_id AND subject_id = $subject_id AND student_id = $student_id AND date = '$date'";
	$result = mysqli_query($GLOBALS['link'], $query);
