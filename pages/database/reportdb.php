...
//Select All Subjects
function selectSubjectReport($subject_id, $member_id){
	establishConnectionToDatabase();

	$query = "select st.name, st.roll_number, a.attendence_year, count(st.roll_number) as report from attendence a left join student st on a.student_id = st.student_id WHERE a.subject_id = $subject_id AND a.member_id = $member_id group by a.attendence_year, st.name order by attendence_year DESC";
